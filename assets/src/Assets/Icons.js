...
//TODO: use FontAwesome instead of MaterialDesign https://react-icons.github.io/react-icons/icons?name=fa
  ...
  return (
    <div>
      {(function () {
        switch (icon) {
          case 'box':
            return (<svg width="2em" height="2em" viewBox="0 0 16 16" className="bi bi-box-seam"
                         fill="currentColor"
          ...
          case 'journal':
            return (<svg width="2em" height="2em" viewBox="0 0 16 16" className="bi bi-journal-arrow-up"
          ...
          case 'gear':
            return (
              <svg width="2em" height="2em" viewBox="0 0 16 16" className="bi bi-gear" fill="currentColor"
                   xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd"
